...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура           = "ОбновлениеИнформационнойБазыПАРеализация.ПеревестиПользователейИзПредыдущейВерсии";
	Обработчик.НачальноеЗаполнение = Истина;
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              	= "1.0.1.4";
	Обработчик.Процедура           	= "Справочники.Аттракционы.ПеренестиФотоВПрисоединенныеФайлы";
	Обработчик.РежимВыполнения		= "Отложенно";
	ОБработчик.Идентификатор		= "58302340-20fa-4b0f-b0a9-e3c250f9dd30";
	Обработчик.Комментарий			= НСтр("ru = 'Перенос файлов из хранилища значения в присоединенные файлы'");

	Обработчик = Обработчики.Добавить();
	Обработчик.Версия = "1.0.1.8";
	Обработчик.Процедура = "ОбновлениеИнформационнойБазыПАРеализация.АктуализироватьВидыКонтактнойИнформации";
	Обработчик.РежимВыполнения = "Оперативно";
	Обработчик.Комментарий = НСтр("ru = 'Обновление свойств предопределенных элементов видов контактной информации.'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              	= "1.0.1.8";
	Обработчик.Процедура           	= "Справочники.Клиенты.ПеренестиТелефонВТабличнуюЧасть";
	Обработчик.РежимВыполнения		= "Отложенно";
	ОБработчик.Идентификатор		= "b2dd9b86-0a67-4e5c-8251-cbdd34f602e3";
	Обработчик.Комментарий			= НСтр("ru = 'Перенос телефона из шапки в ТЧ КонтактнаяИнформация'");
	
	Обработчик = Обработчики.Добавить();
	Обработчик.Версия              	= "1.0.1.13";
	Обработчик.Процедура           	= "ОбновлениеИнформационнойБазыПАРеализация.ЗаполнитьФилиалПосещениеАттракциона";
	Обработчик.РежимВыполнения		= "Отложенно";
	ОБработчик.Идентификатор		= "da281594-8af6-4ae7-a871-bd78e15dd7b8";
	Обработчик.Комментарий			= НСтр("ru = 'Заполнение филиала в Посещении аттракциона'");
